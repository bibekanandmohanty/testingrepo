      ...
      {foreach from=$products item=product}
        <div class="order-line row" >
          <div class="col-sm-2 col-xs-3">
            <span class="image" data-id-ref_id = "{$product.ref_id|escape:'javascript'}" data-id-product-attribute = "{$product.id_product_attribute|escape:'javascript'}" data-id-product = "{$product.id_product|escape:'javascript'}">
          ...
          <div class="col-sm-6 col-xs-12 qty">
            <div class="row">
              <div class="col-xs-5 text-sm-right text-xs-left">{$product.product_price_wt}</div>
              <div class="col-xs-2">{$product.quantity}</div>
              <div class="col-xs-5 text-xs-right bold">{$product.total_wt}</div>
            </div>
          </div>
        </div>
      {/foreach}
