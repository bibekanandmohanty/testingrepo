 ...
 */
class QuotationRequestDetails extends \Illuminate\Database\Eloquent\Model
{
    protected $primaryKey = 'xe_id';
    protected $table = 'quotation_request_details';
    protected $fillable = ['quote_id', 'product_details', 'design_details'];
